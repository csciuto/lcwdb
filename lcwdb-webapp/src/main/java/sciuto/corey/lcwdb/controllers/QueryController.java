...
@Controller
@SessionAttributes({"queryByName","queryByNameResults","cemeteries","sortBy"}) // We don't want to lose these from the model when changing pages.
public class QueryController {
	 ...
	 * 
	 * @param queryByName Must be Valid.
	 * @return
	 */
